...
<head>
    ...
    <meta name="author" content="maria eduarda maroli" />
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item active" href="../temperos/">Temperos</a></li>
            ...
            <div class="carousel-item active" style="background-image: url(assets/slides/slide03.jpg);">
              <div class="carousel-container">
                <div class="carousel-content">
                  <h2 class="animate__animated animate__fadeInDown">Temperos</h2>
